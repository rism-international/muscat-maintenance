...
terms = YAML.load_file("#{Rails.root}/housekeeping/maintenance/20200509-bnf_593.yml")
  ...
  marc.each_by_tag("593") do |n|
    n.each_by_tag("a") do |sf|
      ...
      if new_content != old_content
        modified = true
        maintenance.logger.info("#{maintenance.host}: Source ##{record.id} 593: '#{old_content.yellow}' => '#{new_content.green}'")
